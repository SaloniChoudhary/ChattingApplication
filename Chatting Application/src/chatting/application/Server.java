...
import java.awt.*; // for importing images
import java.awt.event.*; // we used for mouse event
import java.net.*;
import java.io.*;
import javax.swing.plaf.*; // importing for scrollbar 
...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        p1 = new JPanel();  // panel is similar to div in html. It create division.
        p1.setLayout(null);
        // setLocation(400,200);
        p1.setBackground(new Color(7, 94, 84));
        p1.setBounds(0, 0, 450, 70); // (x, y, length, breadth)
        f1.add(p1);
       ...
       a1 = new JPanel();
       //a1.setBounds(5, 75, 440, 570); comment this bcz we dont need after adding scrollbar
       ...
       ScrollBarUI ui = new BasicScrollBarUI(){                 //ScrollBarUI is abstract class whereas BasicScrollBarUI is child class of ScrollBarUI
